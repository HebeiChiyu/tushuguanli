	...
	$.ajax({
		...
		success : function(result) {
			...
			for(i = 0;list[i];i++){
				...
				$("#resultTbody").append("<td>"+list[i].parent.magazine.title+"</td>");
				$("#resultTbody").append("<td>"+list[i].parent.periodcode+"</td>");
				...
				$("#resultTbody").append("<td><a href='<?php echo U('/index/book/detailMagazineVolume/id');?>/"+list[i].id+"'>详情</a></td>");
				$("#resultTbody").append("</tr>");
			}
		},
